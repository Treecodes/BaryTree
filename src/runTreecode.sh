...
export OMP_NUM_THREADS=1
../bin/tree.exe ../examplesOxygenAtom/S79576.bin ../examplesOxygenAtom/348488.bin ../examplesOxygenAtom/ex_st348488_coulomb.bin ../examplesOxygenAtom/out.tsv 348488 348488 0.9 8 1 1000 0.0 0 1 0 0 500
