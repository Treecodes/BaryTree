...
#include "regularized-yukawa_pp.h"


void K_RegularizedYukawa_PP(int number_of_targets_in_batch, int number_of_source_points_in_cluster,
        ...
        struct RunParams *run_params, double *potential, int gpu_async_stream_id)
{
    ...
    #pragma acc loop independent
        ...
        for (int j = 0; j < number_of_source_points_in_cluster; j++) {
            ...
            temporary_potential += source_charge[starting_index_of_source + j] * exp(-kappa*r) / sqrt(r*r + epsilon2);
