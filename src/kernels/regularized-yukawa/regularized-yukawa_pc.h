/* Interaction Kernels */
#ifndef H_K_REGULARIZED_YUKAWA_PC_H
#define H_K_REGULARIZED_YUKAWA_PC_H
...
void K_Regularized_Yukawa_PC_Hermite(int number_of_targets_in_batch, int number_of_interpolation_points_in_cluster,
...
#endif /* H_K_REGULARIZED_YUKAWA_PC_H */
