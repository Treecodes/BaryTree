...
void regularizedCoulombSingularitySubtractionApproximationLagrange(int number_of_targets_in_batch,
...
void regularizedCoulombSingularitySubtractionApproximationHermite(int number_of_targets_in_batch,
