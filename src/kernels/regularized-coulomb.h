/* Interaction Kernels */
#ifndef H_REGULARIZEDCOULOMB_H
#define H_REGULARIZEDCOULOMB_H
 
#include "../struct_kernel.h"


void regularizedCoulombDirect(int number_of_targets_in_batch, int number_of_interpolation_points_in_cluster,
