/* Interaction Kernels */
#ifndef H_K_DCF_CC_HERMITE_H
#define H_K_DCF_CC_HERMITE_H
 
#include "../../run_params/struct_run_params.h"


void K_DCF_CC_Hermite(int number_of_sources_in_batch, int number_of_interpolation_points_in_cluster,
