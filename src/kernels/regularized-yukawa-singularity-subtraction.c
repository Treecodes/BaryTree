...
#include "regularized-yukawa-singularity-subtraction.h"
...
void regularizedYukawaSingularitySubtractionApproximationLagrange(int number_of_targets_in_batch,
...
void regularizedYukawaSingularitySubtractionApproximationHermite(int number_of_targets_in_batch,
