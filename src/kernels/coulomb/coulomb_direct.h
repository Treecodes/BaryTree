/* Interaction Kernels */
#ifndef H_K_COULOMB_DIRECT_H
#define H_K_COULOMB_DIRECT_H
 
#include "../../struct_kernel.h"


void K_Coulomb_Direct(int number_of_targets_in_batch, int number_of_interpolation_points_in_cluster,
