/* Interaction Kernels */
#ifndef H_K_COULOMB_SS_CC_H
#define H_K_COULOMB_SS_CC_H
...
void K_Coulomb_SS_CC_Lagrange(int number_of_sources_in_batch, int number_of_interpolation_points_in_cluster,
        ...
        double *target_cluster_x, double *target_cluster_y, double *target_cluster_z, double *target_cluster_charge, double *target_cluster_weight,
        struct RunParams *run_params, int gpu_async_stream_id);


#endif /* H_K_COULOMB_SS_CC_H */
