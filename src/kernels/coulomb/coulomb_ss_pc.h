/* Interaction Kernels */
#ifndef H_K_COULOMB_SS_PC_H
#define H_K_COULOMB_SS_PC_H
 
#include "../../run_params/struct_run_params.h"


void K_Coulomb_SS_PC_Lagrange(int number_of_targets_in_batch, int number_of_interpolation_points_in_cluster,
...
void K_Coulomb_SS_PC_Hermite(int number_of_targets_in_batch, int number_of_interpolation_points_in_cluster, 
