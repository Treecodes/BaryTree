/* Interaction Kernels */
#ifndef H_K_YUKAWA_SS_PP_H
#define H_K_YUKAWA_SS_PP_H
 
#include "../../run_params/struct_run_params.h"


void K_Yukawa_SS_PP(int number_of_targets_in_batch, int number_of_source_points_in_cluster,
