...
OUTFILE=/home/njvaughn/testing/gpu_coulomb_lagrange.csv 
for N in 1000000
do
	echo N=$N 
	...
	direct-gpu   $SOURCES $TARGETS $DIRECTSUM $OUTFILE $NUMSOURCES $NUMTARGETS $THETA $ORDER $KAPPA $POTENTIALTYPE $NUMDEVICES $NUMTHREADS
